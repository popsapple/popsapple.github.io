...
import { Skills, Items } from './icon-button';
		...
		>
			<li>
				...
				<div className={style.profile}>
					<p>
						디자인과 퍼블리싱을 기반으로 프론트엔드 개발로 전향한 개발자로,
						현업과의 정확한 소통을 통해 정확한 결과물을 만들어내는 것을
						지향합니다. 다양한 프로젝트에서 HTML, CSS, JavaScript, 그리고 React
						등을 여러 프로젝트에서 활용 하였으며, 디자인-개발-기획간의 균형을
						맞춰가며 작업하는 것을 지향합니다.
					</p>
					<div
						itemScope
